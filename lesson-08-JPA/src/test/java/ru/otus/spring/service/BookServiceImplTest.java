...
class BookServiceImplTest {
    ...
    void shouldThrowExceptionNotExistsBook() {
        ...
        assertThatThrownBy(() -> bookService.findBookByTitle(notExistsBook.getTitle())).isInstanceOf(ServiceException.class);
    }
    ...
    void shouldRemoveBook() {
        ...
        assertThatThrownBy(() -> bookService.findBookByTitle(bookDtoToDelete.getTitle())).isInstanceOf(ServiceException.class);
    }
